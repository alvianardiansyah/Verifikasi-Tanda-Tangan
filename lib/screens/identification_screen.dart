...
class _IdentificationScreenState extends State<IdentificationScreen>
  ...
  Future<void> _identifySignature() async {
    ...
    try {
      final result = await _apiService.identifySignature(_selectedImage!);
  ...
  // Widget untuk tampilan kamera dengan rasio 7:5
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Identify Signature'),
        backgroundColor: const Color.fromARGB(255, 33, 150, 243),
          ...
          children: [
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Choose a signature image to identify',
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey[600],
                              ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  _isLoading ? 'Identifying...' : 'Identify Signature',
                  style: const TextStyle(fontSize: 16),
                ),
                onPressed: _isLoading ? null : _identifySignature,
...
// Custom painter untuk panduan scanner
